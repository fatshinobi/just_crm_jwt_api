class AttachmentsController < ApplicationController
  ...
  def index
    records = Attachment.where(attachable: @parent_record)
  ...
  def create
    attachment = Attachment.new(attachable: @parent_record, description: params[:description], uploaded_file: params[:uploaded_file], attachment_type: define_attachment_type)
  ...
  def show
    attachment_rec = to_resource_value
  ...
  def set_parent
    rise Exception.new("Parent record should be set in the child controller")
  end
  ...
  def to_resource_value
    rise Exception.new("Resource value should be set in the child controller")
  end
end
